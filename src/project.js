window.__require = function e(t, n, o) {
        ...
        var a = e("./GameManager"),
            ...
            p = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    console.log("adsButtonFunc2 clicked");
                }, t.prototype.bannerButtonFunc = function() {
                    console.log("bannerButtonFunc clicked");
                }, t.prototype.ShowFailedUi = function(e, t) {
                    var n = this;
                    this.scheduleOnce(function() {
                        r.default.Instance.HideScorePanel(), n.levelTxt.string = r.default.Instance.level.toString(), n.scoreLabel.string = s.default.score.toString(), n.highScoreLabel.string = t, n.resultTxt.string = n.GetContentByScore(e), n.overTxt.string = "Level Progress: " + Math.floor(r.default.Instance.nowYQ / r.default.Instance.passlevelYQ * 100) + "%", n.canClick = !1, n.levelTxt.string = e, n.bgMask.runAction(cc.fadeTo(.36, 150)), n.scheduleOnce(function() {
        ...
        var a = e("../common/PlayerInfo"),
            ...
            m = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    o.parent = this.fruitNode, o.getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruit[e], o.children[0].getComponent(cc.Sprite).spriteFrame = d.default.Instance.fruit[e], o.getComponent("fruitData").fruitNumber = e, o.position = t, o.scale = 0, o.getComponent(cc.RigidBody).linearVelocity = cc.v2(0, -100), o.getComponent(cc.PhysicsCircleCollider).radius = o.height / 2, o.getComponent(cc.PhysicsCircleCollider).restitution = 0.4, o.getComponent(cc.PhysicsCircleCollider).apply(), cc.tween(o).to(.5, {
                        scale: 1
                    }, {
                        easing: "backOut"
                    }).call(function() {
                        null != o.getComponent(cc.PhysicsCircleCollider) && (o.getComponent(cc.PhysicsCircleCollider).radius = o.height / 2, o.getComponent(cc.RigidBody).type = cc.RigidBodyType.Dynamic, o.getComponent(cc.PhysicsCircleCollider).restitution = 0.4, o.getComponent(cc.PhysicsCircleCollider).apply())
        ...
        var a = e("./GameFunction"),
            ...
            p = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    var t = this;
                    i.default.playerTouch && null != a.default.Instance.targetFruit && 1 == this.touchNum && (this.touchNum = 0, a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).radius = a.default.Instance.targetFruit.height / 2, a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).restitution = 0.4, a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).apply(), a.default.Instance.targetFruit.getComponent(cc.RigidBody).type = cc.RigidBodyType.Dynamic, a.default.Instance.targetFruit.getComponent(cc.RigidBody).linearVelocity = cc.v2(0, -800), a.default.Instance.targetFruit = null, this.scheduleOnce(function() {
                        i.default.GameUpdateCtrl && (0 == t.createFruitCount ? (a.default.Instance.createOneFruit(0), t.createFruitCount++) : 1 == t.createFruitCount ? (a.default.Instance.createOneFruit(0), t.createFruitCount++) : 2 == t.createFruitCount ? (a.default.Instance.createOneFruit(1), t.createFruitCount++) : 3 == t.createFruitCount ? (a.default.Instance.createOneFruit(2), t.createFruitCount++) : 4 == t.createFruitCount ? (a.default.Instance.createOneFruit(2), t.createFruitCount++) : 5 == t.createFruitCount ? (a.default.Instance.createOneFruit(3), t.createFruitCount++) : t.createFruitCount > 5 && (a.default.Instance.createOneFruit(s.default.RandomInteger(0, 6)), t.createFruitCount++))
                    }, .5))
            ...
            g = function(e) {
                ...
                return o(t, e), t.prototype.start = function() {}, t.prototype.update = function(e) {}, t.prototype.onCollisionEnter = function(e, t) {
                    ...
                    if (Math.abs(e.y - t.y) <= 15) {
                        ...
                        e.x > 0 ? n.position = cc.v2(e.x - 40, e.y) : n.position = cc.v2(e.x + 40, e.y), n.runAction(cc.sequence(cc.spawn(cc.moveBy(.4, 0, 200), cc.rotateBy(.4, 360)), cc.scaleTo(.15, 1.1), cc.scaleTo(.15, 1), cc.fadeOut(.2))), a.default.score += 50, d.default.Instance.SetScoreTween(a.default.score)
                    } else p.default.Instance.Play(0, !1, 1), a.default.score += 25, d.default.Instance.SetScoreTween(a.default.score)
    ...
    LanguageSetJs: [function(e, t, n) {
        ...
        t.exports = {
            language_1: {
                game_name: "\u300cGem Merge Game\u300d",
                game_name1: "Gem Merge Game",
                game_info: "Combine identical gems to create larger ones!",
                txtStart: "Start",
                txtMore: "More Game",
                txtAgain: "Play Again",
                txtShare1: "In Game ",
        ...
        var a = e("../common/PlayerInfo"),
            ...
            h = function(e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function() {
                    ...
                    console.log("adsButtonFunc clicked");
        ...
        var o = e("HttpManagerJs"),
            ...
            r = (e("GameUiTools"), {
                ...
                gameOverShowText: function(e, t) {
                    console.log("Score saved: " + e);
                },
                gamePV_load: function() {
                    console.log("Game PV loaded");
                },
                ajaxOnLogoResult: function() {},
                ajaxLoad: function(e, t, n) {
                    console.log("Network request skipped: " + e);
                },
            ...
            m = function(e) {
                ...
                return o(t, e), t.prototype.onLoad = function() {}, t.prototype.start = function() {
                    ...
                    if ("downwall" == n.node.group && (t.node.parent = cc.find("Canvas/fruitNode"), 0 == this.wallColl && (d.default.Instance.Play(5, !1, 1), this.wallColl++)), "fruit" == n.node.group) {
                        ...
                        c == r && c < 9 && r < 9 ? (this.pengzhuangCount += 1, 0 == t.node.getComponent("fruitData").getNumber() && (a.default.score += this.fruitNumber * 5 + 10, u.default.Instance.SetScoreTween(a.default.score), n.node.getComponent(cc.PhysicsCircleCollider).radius = 0, n.node.getComponent(cc.PhysicsCircleCollider).restitution = 0.5, n.node.getComponent(cc.PhysicsCircleCollider).apply(), this.node.getComponent(cc.PhysicsCircleCollider).radius = 0, this.node.getComponent(cc.PhysicsCircleCollider).restitution = 0.5, this.node.getComponent(cc.PhysicsCircleCollider).apply(), cc.tween(t.node).to(.1, {
                        ...
                        }).start())) : c == r && 9 == c && 9 == r && (this.pengzhuangCount += 1, 0 == t.node.getComponent("fruitData").getNumber() && (a.default.score += this.fruitNumber * 10 + 200, u.default.Instance.SetScoreTween(a.default.score), n.node.getComponent(cc.PhysicsCircleCollider).radius = 0, n.node.getComponent(cc.PhysicsCircleCollider).restitution = 0.6, n.node.getComponent(cc.PhysicsCircleCollider).apply(), this.node.getComponent(cc.PhysicsCircleCollider).radius = 0, this.node.getComponent(cc.PhysicsCircleCollider).restitution = 0.6, this.node.getComponent(cc.PhysicsCircleCollider).apply(), a.default.playerTouch = !1, cc.tween(t.node).to(.1, {
                            position: n.node.position
                        }).call(function() {
        ...
        cc.Class({
            ...
            onLoad: function() {
                ...
                var e = "Highest Record:",
                    t = this.returnCurrentLanType();
                e = 1 == t ? "Highest Record:" : 2 == t ? "Highest Record:" : 4 == t ? "Highest Record:" : "Highest Record:";
                var n = c.gameScore,
                    o = this.getHighScore();
            ...
            getContentByScore: function(e, t) {
                var n = "I'm amazing! I scored 1 point in " + t + ", only one person in the world has 1 point!",
                ...
                if (e > 0 && e <= o) n = "I scored " + e + " points in " + t + ", great job! Keep practicing!";
                else if (e > o && e <= this.standardScore) n = "I scored " + e + " points in " + t + ", awesome! Keep going!";
                else if (e > this.standardScore && e <= c) {
                    n = "I scored " + e + " points in " + t + ", beating " + (Math.floor(12 * (e - this.standardScore) / (c - this.standardScore)) + 80) + "% of global players!"
                } else if (e > c && e <= a) {
                    n = "I scored " + e + " points in " + t + ", beating " + (Math.floor(7 * (e - c) / (a - c)) + 92) + "% of global players!"
                } else if (e > a && e <= i) n = "I scored " + e + " points in " + t + ", beating 99% of players!";
                else if (e > i && e < this.game_max_score) {
                    n = "I scored " + e + " points in " + t + ", only " + (20 - Math.ceil(17 * (e - i) / (this.game_max_score - i))) + " people worldwide achieved this level!"
                } else e >= this.game_max_score && (n = "I scored " + e + " points in " + t + ", surpassing all records!");
                return n
            },
            strlen: function(e) {
